...
brew 'cmatrix'
brew 'code-minimap'
brew 'colima' # For easy local docker https://github.com/abiosoft/colima
brew 'coreutils'
brew 'ctags'
brew 'curl'
...
brew 'libpq'
brew 'libyaml'
brew 'lima' # https://github.com/lima-vm/lima
brew 'lnav'
...
# # CLI tools not in Homebrew so far
# chunkwm
# fff
...
cask 'rar'
cask 'rectangle'
cask 'semulov' # Eject menu bar https://github.com/kainjow/Semulov
...
# chromium
# docker
# keepingyouawake # via Hammerspoon
